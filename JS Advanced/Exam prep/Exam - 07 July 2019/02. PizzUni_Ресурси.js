...
newClass.registerUser('mitko@dasda.net');

console.log(newClass.doesTheUserExist('mitko@dasda.net'));
newClass.makeAnOrder('mitko@dasda.net','Italian Style', 'Water');
newClass.completeOrder()